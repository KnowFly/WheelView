...
public class WheelView extends View {
    ...
    private int wheelForeground = R.drawable.icon_box_online;
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        canvas.drawCircle(getWidth() / 2, center, 20 * Utils.getScreenDensity(getContext()), circlePaint);
        ...
        canvas.drawText("12", getWidth() / 2, center, textPaint);
    }
